...
_COUNTED = {"reconcile", "context", "deck", "update", "backup", "restore", "lock", "ruleset", "protect", "recover", "standard", "audit"}
...
_USAGE = (
    ...
    "  audit       read the durable plan-audit (list, show, verify, export)\n"
